    ...
    (function (window) {
        var Game = {
            ...
            gameOver: function () {
                ...
                var message3 = "Click pour rejouer";
                this.pause();
            ...
            loop: function () {
                if (!Game.paused) {
                    ...
                    for (var i in Game.enemies) {
                        ...
                        currentEnemy.update();
                        if (
                            Game.currentFrame % currentEnemy.shootingSpeed ===
                            0
                        ) {
                            currentEnemy.shoot();
                        }
        ...
        Player.prototype.update = function () {
            ...
            for (var i in Game.enemyBullets) {
                ...
                if (
                    Game.collision(currentBullet, this) &&
        ...
        Player.prototype.shoot = function () {
            Game.bullets[Game.bulletIndex] = new Bullet(
                this.x + this.width / 2
            );
            Game.bulletIndex++;
        };
        ...
        Enemy.prototype.die = function () {
            ...
            Game.score += 15;
            Game.enemiesAlive =
                Game.enemiesAlive > 1 ? Game.enemiesAlive - 1 : 0;
    ...
    <div class="container">
        <div class="game-wrap">
            ...
            <article class="content">
                ...
                <p>utiliser le flèche <code>gauche</code> et <code>droite</code> pour se déplacer, <code>Espace</code> pour tirer.</p>
